            ...
            <span className="font-label-sm text-label-sm text-secondary uppercase tracking-wider font-semibold">
              About SmartEnergy AI
                        ...
                        <div className="flex flex-wrap gap-6">
                            <div>
                                <div className="font-display-kpi text-display-kpi text-primary tracking-tight gradient-text">2019</div>
                                <div className="font-label-sm text-label-sm text-secondary">Founded</div>
                            </div>
                            <div>
                                <div className="font-display-kpi text-display-kpi text-primary tracking-tight gradient-text">8,400+</div>
                                <div className="font-label-sm text-label-sm text-secondary">Active Users</div>
                            </div>
                            <div>
                                <div className="font-display-kpi text-display-kpi text-primary tracking-tight gradient-text">98.1%</div>
                                <div className="font-label-sm text-label-sm text-secondary">Accuracy Rate</div>
                            </div>
                        </div>
                    </div>
                    <div className="relative">
                        <div className="glass-image rounded-2xl p-8 border border-outline-variant/40">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-surface-container-low/80 rounded-xl p-6 text-center card-hover">
                                    <span className="material-symbols-outlined text-4xl text-primary">lightbulb</span>
                                    <div className="font-headline-sm text-headline-sm font-bold text-primary mt-2">94.2%</div>
                                    <div className="font-label-sm text-label-sm text-secondary">Forecast Accuracy</div>
                                </div>
                                <div className="bg-surface-container-low/80 rounded-xl p-6 text-center card-hover">
                                    <span className="material-symbols-outlined text-4xl text-primary">speed</span>
                                    <div className="font-headline-sm text-headline-sm font-bold text-primary mt-2">14.2ms</div>
                                    <div className="font-label-sm text-label-sm text-secondary">Inference Speed</div>
                                </div>
                                <div className="bg-surface-container-low/80 rounded-xl p-6 text-center card-hover">
                                    <span className="material-symbols-outlined text-4xl text-primary">bolt</span>
                                    <div className="font-headline-sm text-headline-sm font-bold text-primary mt-2">4.2M</div>
                                    <div className="font-label-sm text-label-sm text-secondary">kWh Monitored</div>
                                </div>
                                <div className="bg-surface-container-low/80 rounded-xl p-6 text-center card-hover">
                                    <span className="material-symbols-outlined text-4xl text-primary">devices</span>
                                    <div className="font-headline-sm text-headline-sm font-bold text-primary mt-2">1,400+</div>
                                    <div className="font-label-sm text-label-sm text-secondary">Utilities Covered</div>
                                </div>
                            </div>
                        </div>
                    </div>
