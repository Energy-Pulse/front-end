        ...
        <SectionWrapper id="hero" className="relative pt-16 pb-20 border-b border-outline-variant/30 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              SMARTENERGY AI v1.2 — PRECISION TELEMETRY
                    ...
                    <h1 className="font-headline-lg text-headline-lg md:text-[44px] font-bold tracking-tight mb-4">
                    ...
                    <div className="w-full max-w-2xl py-3 px-6 rounded-xl border border-outline-variant/40 bg-surface-container-low/80 backdrop-blur-sm glass-effect flex flex-wrap items-center justify-between text-secondary font-label-md gap-4">
                  ...
                  <span className="font-label-sm text-label-sm text-secondary uppercase tracking-wider block">
                    Today's Consumption
                                    ...
                                    <div className="flex items-baseline gap-2 mt-1">
                                        <span className="font-display-kpi text-display-kpi text-primary tracking-tight gradient-text">14.63</span>
