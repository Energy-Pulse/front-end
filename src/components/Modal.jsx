...
export const Modal = ({ isOpen, onClose, children, className = '' }) => {
    ...
    return createPortal(
        ...
        >
            <div
                className={`bg-surface-container-lowest rounded-2xl border border-outline-variant w-full max-w-md p-8 shadow-2xl relative animate-in fade-in zoom-in duration-200 ${className}`}
            >
                <button
